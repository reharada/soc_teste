...
public class Busca {
	...
	public void i_put_the_cursor_on_it()  {
		...
		//System.out.println(menuSolucoes + "eh falso");
		WebElement element = driver.findElement(By.cssSelector("#navegacao-superior .mostra-submenu"));
		Actions builder = new Actions(driver);
		builder.moveToElement(element).perform();
		Boolean menuSolucoesAppear = driver.findElement(By.cssSelector(".popover-submenu")).isDisplayed();
